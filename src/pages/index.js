...
export default function Home({data}) {
  ...
  let categories = new Set(); // hashset
  let categoryArray;
  const [typeFilter, setTypeFilter] = useState(false);// food filter
  const foodData = []
...
// getStaticProps is use to when data show automaticaly then use getStaticProps 
